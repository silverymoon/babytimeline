...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'FixedMilestone.text_en'
        db.add_column('timeline_fixedmilestone', 'text_en', self.gf('django.db.models.fields.CharField')(max_length=512, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'FixedMilestone.text_en'
        db.delete_column('timeline_fixedmilestone', 'text_en')
    ...
    models = {
        ...
        'timeline.fixedmilestone': {
            ...
            'text_en': ('django.db.models.fields.CharField', [], {'max_length': '512', 'null': 'True', 'blank': 'True'}),

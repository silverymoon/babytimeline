...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'FixedMilestone', fields ['type']
        db.create_unique('timeline_fixedmilestone', ['type'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'FixedMilestone', fields ['type']
        db.delete_unique('timeline_fixedmilestone', ['type'])

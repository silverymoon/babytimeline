...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'FixedMilestone'
        db.create_table('timeline_fixedmilestone', (
        ...
        db.send_create_signal('timeline', ['FixedMilestone'])

        # Adding field 'Milestone.fixed'
        db.add_column('timeline_milestone', 'fixed', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['timeline.FixedMilestone'], null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting model 'FixedMilestone'
        db.delete_table('timeline_fixedmilestone')

        # Deleting field 'Milestone.fixed'
        db.delete_column('timeline_milestone', 'fixed_id')
